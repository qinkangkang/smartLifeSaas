		...
		<div class="tabs-container">
			...
			<div class="tab-content">
				...
				<tr id="orderMarketDetailList{{idx}}">
					...
					<td>
						<input id="orderMarketDetailList{{idx}}_fgoodsnum" name="orderMarketDetailList[{{idx}}].fgoodsnum" type="text" value="{{row.fgoodsnum}}"    class="form-control required "/>
					</td>
					
					
					<td>
						<input id="orderMarketDetailList{{idx}}_fgoodsprice" name="orderMarketDetailList[{{idx}}].fgoodsprice" type="text" value="{{row.fgoodsprice}}"    class="form-control required "/>
					</td>
					
					
					<td>
						<input id="orderMarketDetailList{{idx}}_fgoodsdiscount" name="orderMarketDetailList[{{idx}}].fgoodsdiscount" type="text" value="{{row.fgoodsdiscount}}"    class="form-control " required/>
					</td>
					<td>
