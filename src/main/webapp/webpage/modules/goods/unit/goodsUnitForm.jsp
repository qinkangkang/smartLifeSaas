...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="goodsUnit" action="${ctx}/goods/unit/goodsUnit/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				<tr>
					...
					<td class="width-35">
						<form:input path="funitname" htmlEscape="false"    class="form-control "/>
					</td>
					<td class="width-15 active"><label class="pull-right">单位启用状态：</label></td>
					<td class="width-35">
