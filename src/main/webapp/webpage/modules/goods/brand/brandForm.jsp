...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="brand" action="${ctx}/goods/brand/brand/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				<tr>
					...
					<td class="width-35">
						<form:input path="fbrandname" htmlEscape="false"    class="form-control required"/>
					</td>
				...
				<tr>
					<td class="width-15 active"><label class="pull-right">品牌状态：</label></td>
					<td class="width-35">
					...
					<td class="width-15 active"><label class="pull-right">描述信息：</label></td>
					<td class="width-35">
