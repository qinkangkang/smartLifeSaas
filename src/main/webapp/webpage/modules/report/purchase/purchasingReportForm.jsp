...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="orderProDetail" action="${ctx}/warehouses/warehouseGoodsInfo/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				...
				<tr>
					...
					<td class="width-35">
						<form:input path="forderprocurement.fordernum" htmlEscape="false"    class="form-control "/>
					</td>
					<td class="width-15 active"><label class="pull-right">采购员：</label></td>
					<td class="width-35">
						<form:input path="forderprocurement.fexecutor.name" htmlEscape="false"    class="form-control "/>
					</td>
				</tr>
				<tr>
					<td class="width-15 active"><label class="pull-right">供应商：</label></td>
					<td class="width-35">
						<form:input path="fsupplier.fname" htmlEscape="false"    class="form-control "/>
					</td>
					<td class="width-15 active"><label class="pull-right">仓库：</label></td>
					<td class="width-35">
						<form:input path="forderprocurement.fwarehose.fname" htmlEscape="false"    class="form-control "/>
					</td>
				</tr>
				<tr>
					<td class="width-15 active"><label class="pull-right">结算账户：</label></td>
					<td class="width-35">
						<form:input path="forderprocurement.fdclearingaccountid.faccountname" htmlEscape="false"    class="form-control "/>
					</td>
					<td class="width-15 active"><label class="pull-right">单据总金额：</label></td>
					<td class="width-35">
						<form:input path="forderprocurement.fordercountprice" htmlEscape="false"    class="form-control "/>
					</td>
				</tr>
				<tr>
					<td class="width-15 active"><label class="pull-right">实付金额：</label></td>
					<td class="width-35">
						<form:input path="forderprocurement.factualpayment" htmlEscape="false"    class="form-control "/>
					</td>
				...
				<tr>
					...
					<td class="width-35">
						<form:input path="forderprocurement.remarks" htmlEscape="false"    class="form-control "/>
					</td>
