...
<body class="hideScroll">
	<form:form id="inputForm" modelAttribute="orderMarketChaDetail"
		action="" method="post"
		...
		<table
			...
			<tbody>
				...
				<tr>
					...
					<td class="width-35">
						<form:input path="fspu.fbuyprice" htmlEscape="false"    class="form-control "/>
					</td>
				...
				<tr>
					...
					<td class="width-35">
						<form:input path="fordermarketchargeback.fordernum" htmlEscape="false"    class="form-control "/>
					</td>
					<td class="width-15 active"><label class="pull-right">制单人：</label></td>
					<td class="width-35">
						<form:input path="fordermarketchargeback.createBy.name" htmlEscape="false"    class="form-control "/>
					</td>
				</tr> 
				<tr>
					<td class="width-15 active"><label class="pull-right">销售员：</label></td>
					<td class="width-35">
						<form:input path="fordermarketchargeback.updateBy.name" htmlEscape="false"    class="form-control "/>
					</td>
					<td class="width-15 active"><label class="pull-right">客户：</label></td>
					<td class="width-35">
						<form:input path="fordermarketchargeback.customerBasic.fname" htmlEscape="false"    class="form-control "/>
					</td>
				</tr> 
				<tr>
					<td class="width-15 active"><label class="pull-right">仓库：</label></td>
					<td class="width-35">
						<form:input path="fordermarketchargeback.warehouse.fname" htmlEscape="false"    class="form-control "/>
					</td>
					<td class="width-15 active"><label class="pull-right">结算账户：</label></td>
					<td class="width-35">
						<form:input path="fordermarketchargeback.clearingAccount.faccountname" htmlEscape="false"    class="form-control "/>
					</td>
				</tr> 
				<tr>
					<td class="width-15 active"><label class="pull-right">单据总金额：</label></td>
					<td class="width-35">
						<form:input path="fordermarketchargeback.fordercountprice" htmlEscape="false"    class="form-control "/>
					</td>
					<td class="width-15 active"><label class="pull-right">实收金额：</label></td>
					<td class="width-35">
						<form:input path="fordermarketchargeback.fdiscountprice" htmlEscape="false"    class="form-control "/>
					</td>
				</tr> 
				<tr>
					<td class="width-15 active"><label class="pull-right">单据日期：</label></td>
					<td class="width-35">
						<form:input path="fordermarketchargeback.fendtime" htmlEscape="false"    class="form-control "/>
					</td>
					<td class="width-15 active"><label class="pull-right">销售员所属门店：</label></td>
					<td class="width-35">
						<form:input path="fordermarketchargeback.updateBy.office.name" htmlEscape="false"    class="form-control "/>
					</td>
				</tr> 
				<tr>
					<td class="width-15 active"><label class="pull-right">仓库所属门店：</label></td>
					<td class="width-35">
						<form:input path="fordermarketchargeback.warehouse.office.name" htmlEscape="false"    class="form-control "/>
					</td>
					<td class="width-15 active"><label class="pull-right">单据备注：</label></td>
					<td class="width-35">
						<form:input path="fordermarketchargeback.remarks" htmlEscape="false"    class="form-control "/>
					</td>
				</tr> 
				<tr>
