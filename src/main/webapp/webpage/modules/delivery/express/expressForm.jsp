...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="express" action="${ctx}/delivery/express/express/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				<tr>
					...
					<td class="width-35">
						<form:input path="fwebsite" htmlEscape="false"    class="form-control "/>
					</td>
				</tr>
				<tr>
					<td class="width-15 active"><label class="pull-right">物流公司：</label></td>
					<td class="width-35">
						<form:select path="fexpresscompany" class="form-control ">
							<form:option value="" label=""/>
							<form:options items="${fns:getDictList('express_company')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
						</form:select>
					</td>
					<td class="width-15 active"><label class="pull-right">运费描述：</label></td>
					<td class="width-35">
						<form:input path="frangedesc" htmlEscape="false"    class="form-control "/>
					</td>
				</tr>
				<tr>
					<td class="width-15 active"><label class="pull-right">商户：</label></td>
					<td class="width-35">
						<form:input path="fsponsorid" htmlEscape="false"    class="form-control "/>
					</td>
