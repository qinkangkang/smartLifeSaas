			...
			<tbody>
				<tr>
					...
					<td class="width-35"><form:select path="fcategoryId"
							...
							<!--  
							<form:options items="${fns:getDictList('fShipmentType')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
							-->
						</form:select></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="width-35"><form:input path="fcellphone"
				...
				<tr>
					...
					<td class="width-35"><form:input path="fbankphone"
							htmlEscape="false" class="form-control " /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="width-35"><form:select path="fisrelate"
							...
							<form:option value="0" label="无" selected="selected" />
				...
				<tr>
					<!-- 
					<td class="width-15 active"><label class="pull-right">关联账号ID：</label></td>
					<td class="width-35">
					...
					<td class="width-35"><form:select path="fpaytype"
							class="form-control required">
							<form:option value="" label="" />
