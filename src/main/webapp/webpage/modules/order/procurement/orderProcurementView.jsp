			...
			<tbody>
				...
				<tr>
					...
					<td class="width-35"><sys:gridselect
							...
							cssClass="form-control" fieldLabels="账户名称|备注"
				...
				<tr>
					...
					<td class="width-15 active"><label class="pull-right">商品价格总额：</label></td>
				...
				<tr>
					...
					<!-- 
					<td class="width-15 active"><label class="pull-right"><font
							color="red">*</font>门店：</label></td>
					<td class="width-35"><sys:treeselect id="fsponsor"
							name="fsponsor.id" value="${orderProcurement.fsponsor.id}"
							labelName="fsponsor.name"
							labelValue="${orderProcurement.fsponsor.name}" title="门店"
				...
				<td class="width-15 active"><label class="pull-right">订单折扣(1~100)%：</label></td>
					...
					<td class="width-15 active"><label class="pull-right">订单折后总价：</label></td>
		...
		<div class="tabs-container">
			...
			<div class="tab-content">
				<div id="tab-1" class="tab-pane active">
					...
					<a class="btn btn-white btn-sm"
						href="${ctx}/order/procurement/orderProcurement/exportDetail?id=${orderProcurement.id}"
				...
				<tr id="orderProDetailList{{idx}}">
					...
					<!--
					<td>
						<input id="orderProDetailList{{idx}}_fsku_colors" name="orderProDetailList[{{idx}}].fsku.colors.id" type="text" value="{{row.fsku.colors.fcolorname}}"    class="form-control required" readonly/>
					</td>
					
					
					<td>
						<input id="orderProDetailList{{idx}}_fsku_size" name="orderProDetailList[{{idx}}].fsku.size.id" type="text" value="{{row.fsku.size.fsizename}}"    class="form-control required" readonly/>
					</td>
					 -->
					...
					<td>
						<input id="orderProDetailList{{idx}}_fdiscountprice" name="orderProDetailList[{{idx}}].fdiscountprice" type="text" value="{{row.fdiscountprice}}"    class="form-control " readonly/>
					</td>
					
					
					<td>
						<input id="orderProDetailList{{idx}}_fcountmoney" name="orderProDetailList[{{idx}}].fcountmoney" type="text" value="{{row.fcountmoney}}"    class="form-control " readonly/>
					</td>
					
					
					<td>
						<input id="orderProDetailList{{idx}}_fdiscountcountmoney" name="orderProDetailList[{{idx}}].fdiscountcountmoney" type="text" value="{{row.fdiscountcountmoney}}"    class="form-control " readonly/>
					</td>
					<td>
						<select style="width:75px;" id="orderProDetailList{{idx}}_fstatus" name="orderProDetailList[{{idx}}].fstatus" data-value="{{row.fstatus}}" class="form-control m-b  ">
