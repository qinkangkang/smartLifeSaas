...
<link href="${ctxStatic}/awesome/4.4/css/font-awesome.min.css"
	rel="stylesheet" />
<!-- jeeplus -->
<link href="${ctxStatic}/common/css/jeeplus.css" type="text/css"
	rel="stylesheet" />
<link href="${ctxStatic}/common/jeeplus.css" type="text/css"
	rel="stylesheet" />
	...
	$(document).ready(function() {
		$("#inputForm").validate({
			...
			$('#sendPassBtn').click(function() {
					...
					$.get(
							"${ctx}/sys/user/resetPassword?mobile="+ $("#tel_resetpass").val(),
							function(data) {
			...
			$('#sendCodeBtn').click(function() {
				...
				$("#sendCodeBtn").attr("disabled",true);
					$.get(
						"${ctx}/sys/register/getRegisterCode?mobile="+ $("#tel").val(),
						function(data) {
							if (data.success == false) {
...
<body  class="login-layout light-login">
	<div style=" padding-left: 20%;padding-right:19.8%;font-family: .PingFangSC-Semibold;">
	    <div style="margin-top: 20%; height:3.3% ;font-size: 30px;color: #FFFFFF;">库存管理系统 <sys:message content="${message}"/></div>
	    <div style="margin-top: 0.6%;font-family: .PingFangSC-Semibold;font-size: 12px;color: #FFFFFF;">inventory management system </div>
		<div style="float:left;width:50%;">
			<div style="font-size: 60px;height: 3.7%;width: 80%;color: #FFFFFF;"> Smart life</div>
			<img src="${pageContext.request.contextPath}/webpage/modules/sys/images/group2.png"/>
		</div>
		<div id="login-box" style="width:40%;border-radius:  8px;float:left;margin-left: 2%; .clear: both;margin-top:5%; " >
				<form id="loginForm"  action="${ctx}/login" method="post">
						<fieldset>
							<label class="block clearfix"> 
								<span class="block input-icon input-icon-right" style="height:18%;margin-bottom: 4.8%;font-size: 18px;"> 
									<input  type="text" id="username" name="username" class="form-control required" value="admin" placeholder="用户名" />
										<i class="ace-icon fa fa-user"></i>
								</span>
							</label>
							<label class="block clearfix" style="margin-top: 5.5%;"> 
								<span class="block input-icon input-icon-right" style=" height:18%;margin-bottom: 4.8%;font-size: 18px;">
								 <input type="password" id="password" name="password" value="admin" style="border-radius: 8px;"
							...
							<div style="float:left;">
								...
								<span class="lbl" style="color: #FFFFFF;margin-left: 15px;"> 记住我</span>
							
							</div>
							<div style="float:right;.clear: both; margin-bottom: 4.8%;">
							...
							<div style="margin-top:5.5%; height: 18%; border-radius: 5px; ">
								<button type="submit" style="width: 100%;background-image: url(${pageContext.request.contextPath}/webpage/modules/sys/images/groupCopy.png); font-size: 18px; color: #FFFFFF;   " >
									<!-- class="width-35 pull-right btn btn-sm btn-primary" -->
									<!-- <i class="ace-icon fa fa-key"></i> -->
									 <span class="bigger-110" style="width: 10%;height: 50%;" >登录</span>
								</button>
							</div>
			...
			<!-- 	<div class="form-options clearfix">
					<div>
						<a href="#" data-target="#forgot-box" class="pull-left"> <font
							color=" #007aff;"><i class="ace-icon fa fa-arrow-left"></i>
								忘记密码</font>
						</a>
					</div>
					...
					<div>
						<a href="#" data-target="#signup-box"
							class="pull-right user-signup-link"> 
		...
		<div class="widget-body bound">
			<div class="widget-main bound">
					...
					<fieldset>
						<label class="block clearfix"> <span
							class="block input-icon input-icon-right"> <input
								id="tel_resetpass" name="mobile" type="tel"
								class="form-control  text-muted required isMobile"
								placeholder="请输入手机号" /> <i class="ace-icon fa fa-envelope"></i>
						</span>
						</label>

						<div class="clearfix">
							<button id="sendPassBtn" type="button"
				...
				<div class="form-options center">
					<br /> <br /> <a href="#" data-target="#login-box" class=""> <font
						color=" #A73438"><i class="ace-icon fa fa-arrow-left"></i>
							返回登录 </font>
					</a>
				</div>
			</div>
		...
		<div class="widget-body bound">
			<div class="widget-main bound">
				...
				<form:form id="inputForm" modelAttribute="user"
					action="${ctx}/sys/register/registerUser" method="post"
					class="form-group form-horizontal">
					<input type="hidden" value="system" name="roleName">
					<!-- 默认注册用户都是超级管理员 -->
					<fieldset>
						<label class="block clearfix"> <span
							class="block input-icon input-icon-right"> <input id="tel"
								name="mobile" type="text" value="" maxlength="11" minlength="11"
								class="form-control text-muted required isMobile"
								placeholder="手机号" /> <i class="ace-icon fa fa-phone"></i>
						</span>
						</label> <label class="block clearfix"> <span
							class="block input-icon input-icon-right"> <input
								id="code" name="randomCode" type="text" value="" maxlength="4"
								minlength="4" class="required" placeholder="验证码" />
								<button class="width-40 pull-right btn btn-sm btn-primary"
									type="button" id="sendCodeBtn">
									<i class="ace-icon fa fa-lightbulb-o"></i> <span
										class="bigger-110">获取验证码!</span>
								</button> <label id="code-error" class="error" for="code"
								style="display: none"></label>
						</span>
						</label> <label class="block clearfix"> <span
							class="block input-icon input-icon-right"> <input
								id="userId" name="loginName" type="text"
								value="${user.loginName }" maxlength="20" minlength="3"
								class="form-control required" placeholder="用户名" /> <i
								class="ace-icon fa fa-user"></i>
						</span>
						</label> <label class="block clearfix"> <span
							class="block input-icon input-icon-right"> <input
								id="newPassword" name="password" type="password" value=""
								maxlength="20" minlength="3" class="form-control required"
								placeholder="密码" /> <i class="ace-icon fa fa-lock"></i>
						</span>
						</label> <label class="block clearfix"> <span
							class="block input-icon input-icon-right"> <input
								id="confirmNewPassword" name="confirmNewPassword"
								type="password" value="" maxlength="20" minlength="3"
								class="form-control required" equalTo="#newPassword"
								placeholder="重复密码" /> <i class="ace-icon fa fa-retweet"></i>
						</span>
						</label> <label class="block"> <input name="ck1" type="checkbox"
							class="required ace" /> <span class="lbl"> 我接受 <a
								href="#">《JeePlus用户注册协议》</a>
						</span> <label id="ck1-error" class="error" for="ck1"
							style="display: none;">必须接受用户协议</label>
						</label>
