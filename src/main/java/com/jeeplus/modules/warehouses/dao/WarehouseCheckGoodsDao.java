 ...
 */
@MyBatisDao
public interface WarehouseCheckGoodsDao extends CrudDao<WarehouseCheckGoods> {

	public List<GoodsSpu> findListBygoodsSpu(GoodsSpu goodsSpu);
	public List<GoodsSku> findListBygoodsSku(GoodsSku goodsSku);
	public List<WarehouseCheckOrder> findListBycheckOrder(WarehouseCheckOrder checkOrder);
